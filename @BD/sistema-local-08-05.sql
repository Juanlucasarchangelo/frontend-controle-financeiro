...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Maio-2023 às 13:55
...
--
ALTER TABLE `informacoes`
  MODIFY `id_camp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
